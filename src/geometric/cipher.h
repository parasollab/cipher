...
struct PathUpdateInfo {
    ...
    // aligned_start_state is an allocState() copy of the early robot's state at max(t1,t2),
    // projected into the refined decomposition via locateSubRegion() to find its sub-cell progress.
